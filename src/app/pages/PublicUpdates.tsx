...
export function PublicUpdates() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast.success('Public update published successfully!');
    setFormData({
      projectId: '',
      title: '',
      description: '',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold text-gray-900">Public Updates</h2>
          <p className="text-gray-600 mt-2">Community updates and project announcements</p>
        </div>
        {canCreateUpdate && (
          <Button
